...
import passwordStyles from "../../Auth/Login/login.module.css";
    ...
    <div className="accountdetails">
      ...
      >
        <Form>
          ...
          <div
            className={`${passwordStyles["password__input"]} ${passwordStyles.form__label}`}
          >
            <TextInputYup
              id="password"
              name="password"
            ...
            {showPass ? (
              <span
                ...
                className={passwordStyles["openedPass"]}
              >
                <svg
              ...
              <span
                onClick={handleShowPassword}
                className={passwordStyles["closedpass"]}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
