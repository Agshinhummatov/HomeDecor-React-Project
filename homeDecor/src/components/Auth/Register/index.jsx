      ...
      <Formik
        ...
        onSubmit={async (user, { resetForm }) => {
          ...
          if (user.password !== user.confirmpassword) {
            ...
            const emailExists = allUsersData.some(
            ...
            if (!emailExists) {
              await fetch(`http://localhost:3000/users`, {
                method: "POST",
                body: JSON.stringify({ ...userData }), // Send userData without confirmpassword
                headers: {
